...
<h3>Savannah's Bridgade of Code for America</h3>
<p>Forked and modified from <a href="https://github.com/codeforamerica/codeofconduct">CFA Code of Conduct</a></p>

<p>The Open Savannah community expects that OpenDataSAV network activities, events, and digital forums:</p>
...
<p>Open Savannah, as a brigade of Code For America, reserves the right to ask anyone in violation of these policies not to participate in Code for America network activities, events, and digital forums.</p>

<h4 id="opensavannahsantiharassmentpolicy">Open Savannah's Anti-Harassment Policy</h4>

<p>This anti-harassment policy is based on <a href="http://geekfeminism.wikia.com/wiki/Conference_anti-harassment/Policy">the example policy</a> from the Geek Feminism wiki, created by the Ada Initiative and other volunteers.</p>
...
<p>All Open Savannah network activities, events, and digital forums and their staff, presenters, and participants are held to an anti-harassment policy, included below.</p>

<p>In addition to governing our own events by this policy, Code for America will only lend their brand and funding to Open Savannah and groups that offer an anti-harassment policy to their attendees. For information on how to offer an anti-harassment policy to your group, <a href="https://docs.google.com/a/codeforamerica.org/document/d/1Zg2FDt7awgfCmdcbzMwKHMb1A7KDOhs_z7ibCb3TLLQ/edit">see this guide</a>.</p>

<p>Code for America (and, by extension, Open Data Savannah) is dedicated to providing a harassment-free experience for everyone regardless of gender, gender identity and expression, sexual orientation, disability, physical appearance, body size, race, age, or religion. We do not tolerate harassment of staff, presenters, and participants in any form. Sexual language and imagery is not appropriate for any Code for America event or network activity, including talks. Anyone in violation of these policies may expelled from Code for America network activities, events, and digital forums, at the discretion of the event organizer or forum administrator.</p>
...
<p>If you are being harassed, notice that someone else is being harassed, or have any other concerns, please contact a member of the event staff or forum administrator immediately. You can contact them at carl@carlvlewis.net or call (912) 816-7007. Event staff or forum administrators will be happy to help participants contact hotel/venue security or local law enforcement, provide escorts, or otherwise assist those experiencing harassment to feel safe for the duration of the event.</p>
...
<h4 id="emailtemplateforantiharassmentreporting">Email Template for Anti-Harassment Reporting</h4>
